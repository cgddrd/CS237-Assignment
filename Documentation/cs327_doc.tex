...
\addcontentsline{toc}{section}{References}
  ...
  \bibitem{notes} B. P. Tiddeman {\em Monster Mash Game Requirements Specification (SE.QA.12)}  2012: Aberystwyth University, Aberystwyth.

   \bibitem{notes} C. J. Price, N. W. Hardy {\em Test Procedure Standards (SE.QA.06)}  2010: Aberystwyth University, Aberystwyth.
